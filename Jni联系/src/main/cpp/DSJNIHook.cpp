...
static int getJNINativeFuncOffset(JNIEnv *env)
{
    ...
    jclass javaClass = env->FindClass("com/example/zk/myapplication/MainActivity");
...
//    }
 ...
 bool DShell1::DSJNIHook::HookJNINative(JNIEnv *env, const char* className, const char* methodName, const char *methodSig, void *replace_func, void **old_func)
{
